...
blocks:
  ...
  - text: |
      ...
      Mike's bio will go here
    _template: textarea
  - text: |
      ### **Eric Slaymaker - Tin Whistle, Mandolin, and Vocals**

      ![](/uploads/eric.jpg)

      Eric's bio will go here
    _template: textarea
  - text: |
      ### **Brian Pachetti - Bazuki and Banjo**

      Brian's pic and bio will go here
    _template: textarea
  - title: Upcoming
    type: short
    _template: events
